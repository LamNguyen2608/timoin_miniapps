...
import MyAnimation from '../general/lottie';
    ...
    return (
        <Stack direction="column" alignItems="center">
            <Box
                ...
                zIndex={-1}
            >
                <MyAnimation animationData={avatar} loop={false} autoplay={true} speed={0.75} />
            </Box>
            <Box>
                <Avatar
            ...
            <Box
                ...
                zIndex={-1}
            >
                <MyAnimation animationData={personalized} loop={true} autoplay={true} speed={0.5} />
            </Box>
            <Typography
                marginTop={3}
